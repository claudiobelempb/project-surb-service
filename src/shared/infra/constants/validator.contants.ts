export class ValidatorConstant {
  static SIZE_MIN_STRING: number = 2
  static SIZE_MAX_STRING: number = 60
  ...
  static REQUIRED_PHONE: string = 'O campo Telefone deve conter apenas dígitos.'
  ...
  static MIN_LENGTH: string = `Campo deve ser maior que ${this.SIZE_MIN_STRING} caracteres`
  static MAX_VALUE: string = ' Campo deve ser menor que '
  static MIN_VALUE: string = ' Campo deve ser maior que '
  static MIN_MAX: string = `Campo deve ter entre ${this.SIZE_MIN_STRING} e ${this.SIZE_MAX_STRING} caracteres.`
